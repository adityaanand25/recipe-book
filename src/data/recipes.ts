...
export const mockRecipes: Recipe[] = [
  ...
  },
  {
    id: '26',
    title: 'Rasam',
    description: 'Spicy and tangy South Indian soup with tamarind and tomatoes',
    image: 'https://images.pexels.com/photos/5560789/pexels-photo-5560789.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    category: 'Soup',
    difficulty: 'Easy',
    cookingTime: 25,
    ...
    instructions: [
      'Extract tamarind juice and boil with turmeric.',
      'Add tomatoes and cook until soft.',
      'Add rasam powder and simmer for 10 minutes.',
      'Heat ghee, add mustard seeds, cumin seeds, curry leaves.',
      'Add garlic, ginger, and red chilies.',
      'Pour tempering over rasam and bring to boil.',
      'Garnish with cilantro and serve hot with rice.'
    ],
    tags: ['South Indian', 'Tamil Nadu', 'Soup', 'Spicy', 'Comfort Food'],
    rating: 4.6,
    author: 'Chef Lakshmi',
  ...
  },
  {
    id: '28',
    title: 'Avial',
    description: 'Kerala mixed vegetables curry cooked in coconut and yogurt',
    image: 'https://images.pexels.com/photos/5560763/pexels-photo-5560763.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    category: 'Main Course',
    difficulty: 'Medium',
    cookingTime: 35,
    ...
    instructions: [
      'Grind coconut, green chilies, and cumin to paste.',
      'Cook all vegetables with little water and salt.',
      'Add coconut paste and mix well.',
      'Whisk yogurt and add to vegetables.',
      'Simmer for 5 minutes without boiling.',
      'Heat coconut oil, add curry leaves.',
      'Pour tempering over avial and serve with rice.'
    ],
    tags: ['Kerala', 'Vegetarian', 'Coconut', 'Traditional', 'Healthy'],
    rating: 4.5,
    author: 'Chef Usha',
  ...
  },
  {
    ...
    description: 'Karnataka special spiced rice and lentil dish with vegetables',
    image: 'https://images.pexels.com/photos/2474658/pexels-photo-2474658.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    category: 'Main Course',
    difficulty: 'Medium',
    cookingTime: 50,
    ...
    instructions: [
      ...
      'Cook vegetables separately and set aside.',
      'Heat ghee, add mustard seeds, curry leaves, asafoetida.',
      'Add onions and tomatoes, cook until soft.',
      'Add tamarind paste and bisi bele bath powder.',
      'Add cooked rice-dal mixture and vegetables.',
      'Simmer for 15 minutes and serve hot with ghee.'
    ],
    tags: ['Karnataka', 'Rice', 'Lentils', 'One-pot', 'Spicy'],
    rating: 4.7,
    author: 'Chef Veena',
  ...
  },
  {
    id: '30',
    title: 'Uttapam',
    description: 'Thick South Indian pancake topped with onions and vegetables',
    image: 'https://images.pexels.com/photos/5560788/pexels-photo-5560788.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    category: 'Breakfast',
    difficulty: 'Medium',
    cookingTime: 30,
    ...
    instructions: [
      'Mix salt into the thick dosa batter.',
      'Heat a non-stick pan or tawa.',
      'Pour batter and spread into thick circle.',
      'Sprinkle onions, tomatoes, green chilies, and carrot on top.',
      'Press gently and drizzle oil around edges.',
      'Cook until golden brown on bottom.',
      'Flip carefully and cook other side.',
      'Serve hot with sambar and coconut chutney.'
    ],
    tags: ['South Indian', 'Breakfast', 'Vegetarian', 'Healthy', 'Fermented'],
    rating: 4.6,
    author: 'Chef Kamala',
  ...
  },
  {
    id: '31',
    title: 'Payasam',
    description: 'Traditional South Indian sweet pudding made with rice and milk',
    image: 'https://images.pexels.com/photos/7625123/pexels-photo-7625123.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    category: 'Dessert',
    difficulty: 'Easy',
    cookingTime: 45,
    ...
    instructions: [
      ...
      'Add rice and cook on low heat for 30 minutes.',
      'Add jaggery and stir until dissolved.',
      'Fry cashews and raisins in ghee until golden.',
      'Add fried nuts, cardamom, and saffron to payasam.',
      'Simmer for 5 more minutes and serve warm or chilled.'
    ],
    tags: ['South Indian', 'Dessert', 'Festival', 'Sweet', 'Traditional'],
    rating: 4.8,
    author: 'Chef Meera',
  ...
  },
  {
    ...
    description: 'Karnataka style dosa with spicy red chutney and potato filling',
    image: 'https://images.pexels.com/photos/5560788/pexels-photo-5560788.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    category: 'Breakfast',
    difficulty: 'Hard',
    cookingTime: 50,
    ...
    instructions: [
      'Roast red chilies, chana dal, urad dal until fragrant.',
      'Grind with coconut and tamarind to make red chutney.',
      'Prepare potato filling as in masala dosa.',
      'Heat dosa pan and pour batter.',
      'Spread red chutney on dosa.',
      'Add potato filling and fold.',
      'Serve hot with sambar and coconut chutney.'
    ],
    tags: ['Karnataka', 'Breakfast', 'Spicy', 'Mysore Style', 'Popular'],
    rating: 4.7,
    author: 'Chef Manjunath',
